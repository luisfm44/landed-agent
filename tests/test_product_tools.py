...
def test_search_products_returns_tool_response(monkeypatch):
    ...
    result = search_products("dt 770 pro", "trace-test")
...
def test_get_product_details_returns_tool_response(monkeypatch):
    def fake_call_landed_api(path, params=None, trace_id=None):
        return {
            "ok": True,
            "trace_id": trace_id,
    ...
    result = get_product_details("dt 770 pro", "trace-test")

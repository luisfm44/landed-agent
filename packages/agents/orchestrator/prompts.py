...
7. Use deal-advisor reasoning when the user asks whether a specific opportunity is a good deal.
8. Synthesize the final response as a RecommendationResult-style answer.
...
Delegation roadmap:
- Today specialist capabilities are exposed as tools and standalone agents.
- As the system matures, wrap specialist agents with AgentTool so the orchestrator delegates to ProductSearchAgent, DealAdvisorAgent, AudioExpertAgent, PricingAgent, ImportCostAgent, and RecommendationAgent.
